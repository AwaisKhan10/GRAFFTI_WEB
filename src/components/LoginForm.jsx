            ...
            < div className="flex justify-center md:flex items-center md:justify-end px-7 relative  py-16" >
                ...
                <div className="z-10 bg-transparent backdrop-blur-md px-6 pt-10 pb-6 rounded-2xl shadow-lg w-96 border border-[#BFBFBF4F]">
                    ...
                    <div className="text-white space-y-4">
                        ...
                        <button className="w-full py-2 bg-gradient-to-r from-[#628EFF] via-[#8740CD] to-[#580475] rounded-xl text-white hover:opacity-90">
                            Login
                        </button>

                        <Link
                            to="/forgot-password"
                            className="flex justify-center font-extralight text-sm hover:underline"
                        >
                            Forgot password?
                        </Link>
