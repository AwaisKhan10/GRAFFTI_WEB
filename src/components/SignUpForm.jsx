            ...
            < div className="flex justify-center md:flex items-center md:justify-end px-7 relative  py-16" >
                ...
                <div className="z-10 bg-transparent backdrop-blur-md px-6 pt-10 pb-6 rounded-2xl shadow-lg w-96 border border-[#BFBFBF4F]">
                    ...
                    <div className="space-y-4">
                        ...
                        <button className="w-full py-2 bg-gradient-to-r from-[#2E4CEE] via-[#221EBF] to-[#040F75] rounded-xl text-white hover:opacity-90">
                            Signup
                        </button>
                        ...
                        {/* <p className="text-center text-sm  mt-4">
                            Already Registered?  <a href="#" className=" hover:underline">Login</a>
                        </p> */}

                        <p className="text-center text-sm mt-4">
                            Already Registered? <Link to="/" className="hover:underline">Login</Link>
                        </p>
